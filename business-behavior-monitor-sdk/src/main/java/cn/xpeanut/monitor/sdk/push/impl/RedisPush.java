package cn.xpeanut.monitor.sdk.push.impl;
...
public class RedisPush implements IPush {
    ...
    public synchronized void open(String host, Integer port) {
        ...
        topic.addListener(LogMessage.class, new LogMessageListener());
    }

    class LogMessageListener implements MessageListener<LogMessage> {
        @Override
